...
class _InvestorProfilePageState extends State<InvestorProfilePage>
  ...
  String _t(String key) {
    final translations = {
      // Intro Screen
      'qiqt_title': {'en': 'QIQT', 'ar': 'QIQT', 'fr': 'QIQT', 'es': 'QIQT', 'zh': 'QIQT', 'ur': 'QIQT'},
      'qiqt_full_title': {'en': 'Quantrock Investor Qualification Test', 'ar': 'اختبار تأهيل المستثمر من كوانتروك', 'fr': 'Test de Qualification des Investisseurs Quantrock', 'es': 'Prueba de Calificación de Inversores Quantrock', 'zh': 'Quantrock投资者资格测试', 'ur': 'کوانٹراک سرمایہ کار اہلیت ٹیسٹ'},
      'qiqt_subtitle': {'en': 'Quantrock Investor Qualification Test (QIQT)', 'ar': 'اختبار تأهيل المستثمر من كوانتروك (QIQT)', 'fr': 'Test de Qualification des Investisseurs Quantrock (QIQT)', 'es': 'Prueba de Calificación de Inversores Quantrock (QIQT)', 'zh': 'Quantrock投资者资格测试 (QIQT)', 'ur': 'کوانٹراک سرمایہ کار اہلیت ٹیسٹ (QIQT)'},
      'intro_text1': {'en': 'QIQT is an intelligent qualification test built on OECD, MIT, and CFA standards, designed to measure your investment experience, financial literacy, motivations, and readiness to learn.', 'ar': 'QIQT هو اختبار تأهيل ذكي مبني على معايير OECD وMIT وCFA، مصمم لقياس خبرتك الاستثمارية ومعرفتك المالية ودوافعك واستعدادك للتعلم.', 'fr': 'QIQT est un test de qualification intelligent basé sur les normes OCDE, MIT et CFA, conçu pour mesurer votre expérience en investissement, vos connaissances financières, vos motivations et votre volonté d\'apprendre.', 'es': 'QIQT es una prueba de calificación inteligente basada en los estándares de OCDE, MIT y CFA, diseñada para medir su experiencia en inversión, conocimientos financieros, motivaciones y disposición para aprender.', 'zh': 'QIQT是基于OECD、MIT和CFA标准构建的智能资格测试，旨在衡量您的投资经验、金融素养、动机和学习意愿。', 'ur': 'QIQT ایک ذہین اہلیت ٹیسٹ ہے جو OECD، MIT اور CFA معیارات پر مبنی ہے، آپ کے سرمایہ کاری کے تجربے، مالی خواندگی، محرکات اور سیکھنے کی تیاری کی پیمائش کے لیے ڈیزائن کیا گیا ہے۔'},
      'intro_text2': {'en': 'QIQT helps you assess your financial knowledge, investment background, and determine your ideal path inside Quantrock whether in challenges, daily lessons, or selecting the appropriate demo portfolio size.', 'ar': 'يساعدك QIQT في تقييم معرفتك المالية وخلفيتك الاستثمارية وتحديد مسارك المثالي داخل كوانتروك سواء في التحديات أو الدروس اليومية أو اختيار حجم المحفظة التجريبية المناسب.', 'fr': 'QIQT vous aide à évaluer vos connaissances financières, votre expérience en investissement et à déterminer votre parcours idéal dans Quantrock, que ce soit dans les défis, les leçons quotidiennes ou le choix de la taille du portefeuille de démonstration appropriée.', 'es': 'QIQT le ayuda a evaluar sus conocimientos financieros, antecedentes de inversión y determinar su camino ideal dentro de Quantrock, ya sea en desafíos, lecciones diarias o seleccionando el tamaño de cartera de demostración apropiado.', 'zh': 'QIQT帮助您评估您的金融知识、投资背景，并确定您在Quantrock内的理想路径，无论是挑战、每日课程还是选择合适的模拟投资组合规模。', 'ur': 'QIQT آپ کی مالی معلومات، سرمایہ کاری کے پس منظر کا جائزہ لینے اور Quantrock کے اندر آپ کے مثالی راستے کا تعین کرنے میں مدد کرتا ہے چاہے چیلنجز، روزانہ سبق، یا مناسب ڈیمو پورٹ فولیو سائز کا انتخاب ہو۔'},
      'purpose_title': {'en': 'What is the purpose of QIQT?', 'ar': 'ما هو الغرض من QIQT؟', 'fr': 'Quel est le but de QIQT?', 'es': '¿Cuál es el propósito de QIQT?', 'zh': 'QIQT的目的是什么？', 'ur': 'QIQT کا مقصد کیا ہے؟'},
      'purpose_subtitle': {'en': 'The test aims to accurately classify the user into one of the following levels:', 'ar': 'يهدف الاختبار إلى تصنيف المستخدم بدقة إلى أحد المستويات التالية:', 'fr': 'Le test vise à classer précisément l\'utilisateur dans l\'un des niveaux suivants:', 'es': 'La prueba tiene como objetivo clasificar con precisión al usuario en uno de los siguientes niveles:', 'zh': '该测试旨在准确地将用户分类为以下级别之一：', 'ur': 'ٹیسٹ کا مقصد صارف کو درج ذیل سطحوں میں سے کسی ایک میں درست طریقے سے درجہ بندی کرنا ہے:'},
      'beginner': {'en': 'Beginner', 'ar': 'مبتدئ', 'fr': 'Débutant', 'es': 'Principiante', 'zh': '初学者', 'ur': 'ابتدائی'},
      'intermediate': {'en': 'Intermediate', 'ar': 'متوسط', 'fr': 'Intermédiaire', 'es': 'Intermedio', 'zh': '中级', 'ur': 'درمیانی'},
      'advanced': {'en': 'Advanced', 'ar': 'متقدم', 'fr': 'Avancé', 'es': 'Avanzado', 'zh': '高级', 'ur': 'ایڈوانسڈ'},
      'identifies_title': {'en': 'It works on identifying:', 'ar': 'يعمل على تحديد:', 'fr': 'Il travaille à identifier:', 'es': 'Trabaja en identificar:', 'zh': '它致力于识别：', 'ur': 'یہ شناخت کرنے پر کام کرتا ہے:'},
      'item_objectives': {'en': 'Investment objectives', 'ar': 'أهداف الاستثمار', 'fr': 'Objectifs d\'investissement', 'es': 'Objetivos de inversión', 'zh': '投资目标', 'ur': 'سرمایہ کاری کے مقاصد'},
      'item_experience': {'en': 'Investment experience', 'ar': 'الخبرة الاستثمارية', 'fr': 'Expérience en investissement', 'es': 'Experiencia en inversión', 'zh': '投资经验', 'ur': 'سرمایہ کاری کا تجربہ'},
      'item_literacy': {'en': 'Financial knowledge and literacy', 'ar': 'المعرفة والثقافة المالية', 'fr': 'Connaissances et culture financières', 'es': 'Conocimiento y cultura financiera', 'zh': '金融知识和素养', 'ur': 'مالی علم اور خواندگی'},
      'item_readiness': {'en': 'Level of readiness and willingness to learn', 'ar': 'مستوى الاستعداد والرغبة في التعلم', 'fr': 'Niveau de préparation et volonté d\'apprendre', 'es': 'Nivel de preparación y disposición para aprender', 'zh': '学习准备和意愿程度', 'ur': 'تیاری کی سطح اور سیکھنے کی خواہش'},
      'item_challenge': {'en': 'The appropriate challenge level', 'ar': 'مستوى التحدي المناسب', 'fr': 'Le niveau de défi approprié', 'es': 'El nivel de desafío apropiado', 'zh': '适当的挑战级别', 'ur': 'مناسب چیلنج کی سطح'},
      'item_portfolio': {'en': 'The appropriate simulated portfolio size', 'ar': 'حجم المحفظة التجريبية المناسب', 'fr': 'La taille de portefeuille simulé appropriée', 'es': 'El tamaño de cartera simulada apropiado', 'zh': '适当的模拟投资组合规模', 'ur': 'مناسب تجرباتی پورٹ فولیو سائز'},
      'item_path': {'en': 'The best learning path', 'ar': 'أفضل مسار للتعلم', 'fr': 'Le meilleur parcours d\'apprentissage', 'es': 'El mejor camino de aprendizaje', 'zh': '最佳学习路径', 'ur': 'بہترین سیکھنے کا راستہ'},
      'item_motivation': {'en': 'The motivation for using the Quantrock app', 'ar': 'الدافع لاستخدام تطبيق كوانتروك', 'fr': 'La motivation pour utiliser l\'application Quantrock', 'es': 'La motivación para usar la aplicación Quantrock', 'zh': '使用Quantrock应用的动机', 'ur': 'Quantrock ایپ استعمال کرنے کی ترغیب'},
      'start_test': {'en': 'Start The Test', 'ar': 'ابدأ الاختبار', 'fr': 'Commencer le Test', 'es': 'Iniciar la Prueba', 'zh': '开始测试', 'ur': 'ٹیسٹ شروع کریں'},
      'questions_count': {'en': '20 Questions', 'ar': '20 سؤال', 'fr': '20 Questions', 'es': '20 Preguntas', 'zh': '20个问题', 'ur': '20 سوالات'},
      'time_estimate': {'en': '~5 minutes', 'ar': '~5 دقائق', 'fr': '~5 minutes', 'es': '~5 minutos', 'zh': '~5分钟', 'ur': '~5 منٹ'},

      // Questions
      'q1_title': {'en': 'What is your gender?', 'ar': 'ما هو جنسك؟', 'fr': 'Quel est votre genre?', 'es': '¿Cuál es su género?', 'zh': '您的性别是什么？', 'ur': 'آپ کی جنس کیا ہے؟'},
      'q1_male': {'en': 'Male', 'ar': 'ذكر', 'fr': 'Homme', 'es': 'Masculino', 'zh': '男', 'ur': 'مرد'},
      'q1_female': {'en': 'Female', 'ar': 'أنثى', 'fr': 'Femme', 'es': 'Femenino', 'zh': '女', 'ur': 'عورت'},
      'q1_other': {'en': 'Prefer not to say', 'ar': 'أفضل عدم الإجابة', 'fr': 'Préfère ne pas dire', 'es': 'Prefiero no decir', 'zh': '不愿透露', 'ur': 'بتانا پسند نہیں'},

      'q2_title': {'en': 'What is your age group?', 'ar': 'ما هي فئتك العمرية؟', 'fr': 'Quel est votre groupe d\'âge?', 'es': '¿Cuál es su grupo de edad?', 'zh': '您的年龄段是？', 'ur': 'آپ کی عمر کا گروپ کیا ہے؟'},
      'q2_under18': {'en': 'Under 18', 'ar': 'أقل من 18', 'fr': 'Moins de 18 ans', 'es': 'Menor de 18', 'zh': '18岁以下', 'ur': '18 سے کم'},
      'q2_18_24': {'en': '18-24', 'ar': '18-24', 'fr': '18-24', 'es': '18-24', 'zh': '18-24', 'ur': '18-24'},
      'q2_25_34': {'en': '25-34', 'ar': '25-34', 'fr': '25-34', 'es': '25-34', 'zh': '25-34', 'ur': '25-34'},
      'q2_35_44': {'en': '35-44', 'ar': '35-44', 'fr': '35-44', 'es': '35-44', 'zh': '35-44', 'ur': '35-44'},
      'q2_45_54': {'en': '45-54', 'ar': '45-54', 'fr': '45-54', 'es': '45-54', 'zh': '45-54', 'ur': '45-54'},
      'q2_55plus': {'en': '55+', 'ar': '+55', 'fr': '55+', 'es': '55+', 'zh': '55+', 'ur': '55+'},

      'q3_title': {'en': 'How much time can you commit to learning each week?', 'ar': 'كم من الوقت يمكنك تخصيصه للتعلم كل أسبوع؟', 'fr': 'Combien de temps pouvez-vous consacrer à l\'apprentissage chaque semaine?', 'es': '¿Cuánto tiempo puede dedicar al aprendizaje cada semana?', 'zh': '您每周可以投入多少时间学习？', 'ur': 'آپ ہر ہفتے سیکھنے کے لیے کتنا وقت دے سکتے ہیں؟'},
      'q3_less1': {'en': 'Less than 1 hour', 'ar': 'أقل من ساعة', 'fr': 'Moins d\'1 heure', 'es': 'Menos de 1 hora', 'zh': '少于1小时', 'ur': '1 گھنٹے سے کم'},
      'q3_1_3': {'en': '1–3 hours', 'ar': '1-3 ساعات', 'fr': '1-3 heures', 'es': '1-3 horas', 'zh': '1-3小时', 'ur': '1-3 گھنٹے'},
      'q3_3_7': {'en': '3–7 hours', 'ar': '3-7 ساعات', 'fr': '3-7 heures', 'es': '3-7 horas', 'zh': '3-7小时', 'ur': '3-7 گھنٹے'},
      'q3_more7': {'en': 'More than 7 hours', 'ar': 'أكثر من 7 ساعات', 'fr': 'Plus de 7 heures', 'es': 'Más de 7 horas', 'zh': '超过7小时', 'ur': '7 گھنٹے سے زیادہ'},

      'q4_title': {'en': 'Do you currently have an active investment portfolio?', 'ar': 'هل لديك حالياً محفظة استثمارية نشطة؟', 'fr': 'Avez-vous actuellement un portefeuille d\'investissement actif?', 'es': '¿Tiene actualmente una cartera de inversión activa?', 'zh': '您目前有活跃的投资组合吗？', 'ur': 'کیا آپ کے پاس فی الحال ایک فعال سرمایہ کاری پورٹ فولیو ہے؟'},
      'q4_yes': {'en': 'Yes, actively managing', 'ar': 'نعم، أديرها بنشاط', 'fr': 'Oui, gestion active', 'es': 'Sí, gestión activa', 'zh': '是的，正在积极管理', 'ur': 'ہاں، فعال طور پر منظم کر رہا ہوں'},
      'q4_no': {'en': 'No portfolio', 'ar': 'لا يوجد محفظة', 'fr': 'Pas de portefeuille', 'es': 'Sin cartera', 'zh': '没有投资组合', 'ur': 'کوئی پورٹ فولیو نہیں'},
      'q4_used_to': {'en': 'I used to have one', 'ar': 'كان لدي واحدة سابقاً', 'fr': 'J\'en avais un', 'es': 'Solía tener uno', 'zh': '我以前有过', 'ur': 'میرے پاس پہلے تھا'},

      'q5_title': {'en': 'What is the approximate size of your current, latest or future portfolio?', 'ar': 'ما هو الحجم التقريبي لمحفظتك الحالية أو الأخيرة أو المستقبلية؟', 'fr': 'Quelle est la taille approximative de votre portefeuille actuel, récent ou futur?', 'es': '¿Cuál es el tamaño aproximado de su cartera actual, reciente o futura?', 'zh': '您当前、最近或未来投资组合的大致规模是多少？', 'ur': 'آپ کے موجودہ، حالیہ یا مستقبل کے پورٹ فولیو کا تقریباً سائز کیا ہے؟'},
      'q5_less1k': {'en': 'Less than \$0.00 - \$1,000', 'ar': 'أقل من 0.00\$ - 1,000\$', 'fr': 'Moins de 0,00\$ - 1 000\$', 'es': 'Menos de \$0.00 - \$1,000', 'zh': '少于\$0.00 - \$1,000', 'ur': '\$0.00 - \$1,000 سے کم'},
      'q5_1k_10k': {'en': '\$1,000–\$10,000', 'ar': '1,000\$–10,000\$', 'fr': '1 000\$–10 000\$', 'es': '\$1,000–\$10,000', 'zh': '\$1,000–\$10,000', 'ur': '\$1,000–\$10,000'},
      'q5_10k_25k': {'en': '\$10,000–\$25,000', 'ar': '10,000\$–25,000\$', 'fr': '10 000\$–25 000\$', 'es': '\$10,000–\$25,000', 'zh': '\$10,000–\$25,000', 'ur': '\$10,000–\$25,000'},
      'q5_25k_100k': {'en': '\$25,000–\$100,000', 'ar': '25,000\$–100,000\$', 'fr': '25 000\$–100 000\$', 'es': '\$25,000–\$100,000', 'zh': '\$25,000–\$100,000', 'ur': '\$25,000–\$100,000'},
      'q5_100k_500k': {'en': '\$100,000–\$500,000', 'ar': '100,000\$–500,000\$', 'fr': '100 000\$–500 000\$', 'es': '\$100,000–\$500,000', 'zh': '\$100,000–\$500,000', 'ur': '\$100,000–\$500,000'},
      'q5_more500k': {'en': 'More than \$500,000', 'ar': 'أكثر من 500,000\$', 'fr': 'Plus de 500 000\$', 'es': 'Más de \$500,000', 'zh': '超过\$500,000', 'ur': '\$500,000 سے زیادہ'},

      'q6_title': {'en': 'Rate your knowledge in the following areas', 'ar': 'قيّم معرفتك في المجالات التالية', 'fr': 'Évaluez vos connaissances dans les domaines suivants', 'es': 'Califique su conocimiento en las siguientes áreas', 'zh': '评估您在以下领域的知识', 'ur': 'درج ذیل شعبوں میں اپنے علم کی درجہ بندی کریں'},
      'q6_stock_market': {'en': 'Stock Market', 'ar': 'سوق الأسهم', 'fr': 'Marché boursier', 'es': 'Mercado de valores', 'zh': '股票市场', 'ur': 'سٹاک مارکیٹ'},
      'q6_risk': {'en': 'Risk management', 'ar': 'إدارة المخاطر', 'fr': 'Gestion des risques', 'es': 'Gestión de riesgos', 'zh': '风险管理', 'ur': 'رسک مینجمنٹ'},
      'q6_technical': {'en': 'Technical and fundamental analysis', 'ar': 'التحليل الفني والأساسي', 'fr': 'Analyse technique et fondamentale', 'es': 'Análisis técnico y fundamental', 'zh': '技术和基本面分析', 'ur': 'تکنیکی اور بنیادی تجزیہ'},
      'q6_diversification': {'en': 'Portfolio diversification', 'ar': 'تنويع المحفظة', 'fr': 'Diversification du portefeuille', 'es': 'Diversificación de cartera', 'zh': '投资组合多元化', 'ur': 'پورٹ فولیو ڈائیورسیفیکیشن'},

      'q7_title': {'en': 'Which asset classes have you invested in before?', 'ar': 'ما هي فئات الأصول التي استثمرت فيها من قبل؟', 'fr': 'Dans quelles classes d\'actifs avez-vous investi auparavant?', 'es': '¿En qué clases de activos ha invertido antes?', 'zh': '您以前投资过哪些资产类别？', 'ur': 'آپ نے پہلے کن اثاثہ جات کی کلاسوں میں سرمایہ کاری کی ہے؟'},
      'q7_stocks': {'en': 'Stocks', 'ar': 'أسهم', 'fr': 'Actions', 'es': 'Acciones', 'zh': '股票', 'ur': 'سٹاکس'},
      'q7_etfs': {'en': 'ETFs', 'ar': 'صناديق المؤشرات', 'fr': 'ETFs', 'es': 'ETFs', 'zh': 'ETFs', 'ur': 'ETFs'},
      'q7_crypto': {'en': 'Cryptocurrency', 'ar': 'عملات رقمية', 'fr': 'Cryptomonnaie', 'es': 'Criptomoneda', 'zh': '加密货币', 'ur': 'کرپٹو کرنسی'},
      'q7_bonds': {'en': 'Bonds', 'ar': 'سندات', 'fr': 'Obligations', 'es': 'Bonos', 'zh': '债券', 'ur': 'بانڈز'},
      'q7_real_estate': {'en': 'Real Estate', 'ar': 'عقارات', 'fr': 'Immobilier', 'es': 'Bienes raíces', 'zh': '房地产', 'ur': 'رئیل اسٹیٹ'},
      'q7_commodities': {'en': 'Commodities', 'ar': 'سلع', 'fr': 'Matières premières', 'es': 'Materias primas', 'zh': '大宗商品', 'ur': 'کموڈٹیز'},
      'q7_metals': {'en': 'Metals', 'ar': 'معادن', 'fr': 'Métaux', 'es': 'Metales', 'zh': '金属', 'ur': 'دھاتیں'},
      'q7_forex': {'en': 'Forex', 'ar': 'فوركس', 'fr': 'Forex', 'es': 'Forex', 'zh': '外汇', 'ur': 'فاریکس'},
      'q7_none': {'en': 'None', 'ar': 'لا شيء', 'fr': 'Aucun', 'es': 'Ninguno', 'zh': '无', 'ur': 'کوئی نہیں'},

      'q8_title': {'en': 'How comfortable are you reading financial charts?', 'ar': 'ما مدى ارتياحك في قراءة الرسوم البيانية المالية؟', 'fr': 'À quel point êtes-vous à l\'aise pour lire des graphiques financiers?', 'es': '¿Qué tan cómodo se siente leyendo gráficos financieros?', 'zh': '您阅读金融图表的舒适程度如何？', 'ur': 'مالیاتی چارٹس پڑھنے میں آپ کتنے آرام دہ ہیں؟'},
      'q8_not': {'en': 'Not comfortable', 'ar': 'غير مرتاح', 'fr': 'Pas à l\'aise', 'es': 'No cómodo', 'zh': '不舒适', 'ur': 'آرام دہ نہیں'},
      'q8_slightly': {'en': 'Slightly comfortable', 'ar': 'مرتاح قليلاً', 'fr': 'Légèrement à l\'aise', 'es': 'Ligeramente cómodo', 'zh': '稍微舒适', 'ur': 'تھوڑا آرام دہ'},
      'q8_comfortable': {'en': 'Comfortable', 'ar': 'مرتاح', 'fr': 'À l\'aise', 'es': 'Cómodo', 'zh': '舒适', 'ur': 'آرام دہ'},
      'q8_very': {'en': 'Very comfortable', 'ar': 'مرتاح جداً', 'fr': 'Très à l\'aise', 'es': 'Muy cómodo', 'zh': '非常舒适', 'ur': 'بہت آرام دہ'},

      'q9_title': {'en': 'What is your preferred investment time horizon?', 'ar': 'ما هو أفقك الزمني المفضل للاستثمار؟', 'fr': 'Quel est votre horizon d\'investissement préféré?', 'es': '¿Cuál es su horizonte de inversión preferido?', 'zh': '您首选的投资时间范围是多少？', 'ur': 'آپ کا ترجیحی سرمایہ کاری کا وقت کیا ہے؟'},
      'q9_less1': {'en': 'Less than 1 year', 'ar': 'أقل من سنة', 'fr': 'Moins d\'1 an', 'es': 'Menos de 1 año', 'zh': '少于1年', 'ur': '1 سال سے کم'},
      'q9_1_3': {'en': '1-3 years', 'ar': '1-3 سنوات', 'fr': '1-3 ans', 'es': '1-3 años', 'zh': '1-3年', 'ur': '1-3 سال'},
      'q9_3_7': {'en': '3-7 years', 'ar': '3-7 سنوات', 'fr': '3-7 ans', 'es': '3-7 años', 'zh': '3-7年', 'ur': '3-7 سال'},
      'q9_more7': {'en': 'More than 7 years', 'ar': 'أكثر من 7 سنوات', 'fr': 'Plus de 7 ans', 'es': 'Más de 7 años', 'zh': '超过7年', 'ur': '7 سال سے زیادہ'},

      'q10_title': {'en': 'How would you rate your understanding of market risk?', 'ar': 'كيف تقيّم فهمك لمخاطر السوق؟', 'fr': 'Comment évalueriez-vous votre compréhension du risque de marché?', 'es': '¿Cómo calificaría su comprensión del riesgo de mercado?', 'zh': '您如何评价您对市场风险的理解？', 'ur': 'آپ مارکیٹ رسک کے بارے میں اپنی سمجھ کی درجہ بندی کیسے کریں گے؟'},
      'q10_poor': {'en': 'Poor', 'ar': 'ضعيف', 'fr': 'Faible', 'es': 'Pobre', 'zh': '差', 'ur': 'کمزور'},
      'q10_basic': {'en': 'Basic', 'ar': 'أساسي', 'fr': 'Basique', 'es': 'Básico', 'zh': '基本', 'ur': 'بنیادی'},
      'q10_good': {'en': 'Good', 'ar': 'جيد', 'fr': 'Bon', 'es': 'Bueno', 'zh': '好', 'ur': 'اچھا'},
      'q10_excellent': {'en': 'Excellent', 'ar': 'ممتاز', 'fr': 'Excellent', 'es': 'Excelente', 'zh': '优秀', 'ur': 'بہترین'},

      'q11_title': {'en': 'How would you describe your saving habits?', 'ar': 'كيف تصف عادات الادخار لديك؟', 'fr': 'Comment décririez-vous vos habitudes d\'épargne?', 'es': '¿Cómo describiría sus hábitos de ahorro?', 'zh': '您如何描述您的储蓄习惯？', 'ur': 'آپ اپنی بچت کی عادات کو کیسے بیان کریں گے؟'},
      'q11_dont': {'en': "I don't save regularly", 'ar': 'لا أدخر بانتظام', 'fr': 'Je n\'épargne pas régulièrement', 'es': 'No ahorro regularmente', 'zh': '我不经常储蓄', 'ur': 'میں باقاعدگی سے نہیں بچاتا'},
      'q11_sometimes': {'en': 'I save sometimes', 'ar': 'أدخر أحياناً', 'fr': 'J\'épargne parfois', 'es': 'Ahorro a veces', 'zh': '我有时储蓄', 'ur': 'میں کبھی کبھی بچاتا ہوں'},
      'q11_regularly': {'en': 'I save regularly', 'ar': 'أدخر بانتظام', 'fr': 'J\'épargne régulièrement', 'es': 'Ahorro regularmente', 'zh': '我经常储蓄', 'ur': 'میں باقاعدگی سے بچاتا ہوں'},
      'q11_fixed': {'en': 'I save a fixed percentage', 'ar': 'أدخر نسبة ثابتة', 'fr': 'J\'épargne un pourcentage fixe', 'es': 'Ahorro un porcentaje fijo', 'zh': '我储蓄固定比例', 'ur': 'میں ایک مقررہ فیصد بچاتا ہوں'},

      'q12_title': {'en': 'Do you have emergency savings (3-6 months expenses)?', 'ar': 'هل لديك مدخرات طوارئ (3-6 أشهر من المصاريف)؟', 'fr': 'Avez-vous une épargne d\'urgence (3-6 mois de dépenses)?', 'es': '¿Tiene ahorros de emergencia (3-6 meses de gastos)?', 'zh': '您有应急储蓄（3-6个月的支出）吗？', 'ur': 'کیا آپ کے پاس ہنگامی بچت ہے (3-6 ماہ کے اخراجات)؟'},
      'q12_yes': {'en': 'Yes', 'ar': 'نعم', 'fr': 'Oui', 'es': 'Sí', 'zh': '是', 'ur': 'ہاں'},
      'q12_no': {'en': 'No', 'ar': 'لا', 'fr': 'Non', 'es': 'No', 'zh': '否', 'ur': 'نہیں'},

      'q13_title': {'en': 'Have you started planning for retirement?', 'ar': 'هل بدأت التخطيط للتقاعد؟', 'fr': 'Avez-vous commencé à planifier votre retraite?', 'es': '¿Ha comenzado a planificar su jubilación?', 'zh': '您开始规划退休了吗？', 'ur': 'کیا آپ نے ریٹائرمنٹ کی منصوبہ بندی شروع کر دی ہے؟'},
      'q13_not_yet': {'en': 'Not yet', 'ar': 'ليس بعد', 'fr': 'Pas encore', 'es': 'Todavía no', 'zh': '还没有', 'ur': 'ابھی نہیں'},
      'q13_pension': {'en': 'Yes, through pension', 'ar': 'نعم، من خلال المعاش', 'fr': 'Oui, par la pension', 'es': 'Sí, a través de la pensión', 'zh': '是的，通过养老金', 'ur': 'ہاں، پنشن کے ذریعے'},
      'q13_save': {'en': 'Yes, I save regularly for it', 'ar': 'نعم، أدخر لذلك بانتظام', 'fr': 'Oui, j\'épargne régulièrement pour cela', 'es': 'Sí, ahorro regularmente para ello', 'zh': '是的，我为此定期储蓄', 'ur': 'ہاں، میں اس کے لیے باقاعدگی سے بچاتا ہوں'},

      'q14_title': {'en': 'What is your risk tolerance?', 'ar': 'ما هو مستوى تحملك للمخاطر؟', 'fr': 'Quelle est votre tolérance au risque?', 'es': '¿Cuál es su tolerancia al riesgo?', 'zh': '您的风险承受能力是多少？', 'ur': 'آپ کی رسک برداشت کیا ہے؟'},
      'q14_very_low': {'en': 'Very Low', 'ar': 'منخفض جداً', 'fr': 'Très faible', 'es': 'Muy bajo', 'zh': '非常低', 'ur': 'بہت کم'},
      'q14_low': {'en': 'Low', 'ar': 'منخفض', 'fr': 'Faible', 'es': 'Bajo', 'zh': '低', 'ur': 'کم'},
      'q14_medium': {'en': 'Medium', 'ar': 'متوسط', 'fr': 'Moyen', 'es': 'Medio', 'zh': '中等', 'ur': 'درمیانی'},
      'q14_high': {'en': 'High', 'ar': 'عالي', 'fr': 'Élevé', 'es': 'Alto', 'zh': '高', 'ur': 'زیادہ'},

      'q15_title': {'en': 'What is your main investment goal?', 'ar': 'ما هو هدفك الاستثماري الرئيسي؟', 'fr': 'Quel est votre principal objectif d\'investissement?', 'es': '¿Cuál es su principal objetivo de inversión?', 'zh': '您的主要投资目标是什么？', 'ur': 'آپ کا اصل سرمایہ کاری کا مقصد کیا ہے؟'},
      'q15_protection': {'en': 'Capital Protection', 'ar': 'حماية رأس المال', 'fr': 'Protection du capital', 'es': 'Protección del capital', 'zh': '资本保护', 'ur': 'سرمائے کا تحفظ'},
      'q15_income': {'en': 'Extra Income', 'ar': 'دخل إضافي', 'fr': 'Revenu supplémentaire', 'es': 'Ingreso extra', 'zh': '额外收入', 'ur': 'اضافی آمدنی'},
      'q15_growth': {'en': 'Capital Growth', 'ar': 'نمو رأس المال', 'fr': 'Croissance du capital', 'es': 'Crecimiento del capital', 'zh': '资本增长', 'ur': 'سرمائے کی نمو'},
      'q15_wealth': {'en': 'Long-term Wealth', 'ar': 'الثروة طويلة الأجل', 'fr': 'Richesse à long terme', 'es': 'Riqueza a largo plazo', 'zh': '长期财富', 'ur': 'طویل مدتی دولت'},
      'q15_speculation': {'en': 'Short-term Trading', 'ar': 'التداول قصير الأجل', 'fr': 'Trading à court terme', 'es': 'Trading a corto plazo', 'zh': '短期交易', 'ur': 'قلیل مدتی تجارت'},

      'q16_title': {'en': 'What is your goal from using Quantrock?', 'ar': 'ما هو هدفك من استخدام كوانتروك؟', 'fr': 'Quel est votre objectif en utilisant Quantrock?', 'es': '¿Cuál es su objetivo al usar Quantrock?', 'zh': '您使用Quantrock的目标是什么？', 'ur': 'Quantrock استعمال کرنے کا آپ کا مقصد کیا ہے؟'},
      'q16_learn': {'en': 'Learn about investing', 'ar': 'تعلم الاستثمار', 'fr': 'Apprendre l\'investissement', 'es': 'Aprender sobre inversión', 'zh': '学习投资', 'ur': 'سرمایہ کاری سیکھنا'},
      'q16_challenge': {'en': 'Take trading challenges', 'ar': 'خوض تحديات التداول', 'fr': 'Relever des défis de trading', 'es': 'Tomar desafíos de trading', 'zh': '接受交易挑战', 'ur': 'تجارتی چیلنجز لینا'},
      'q16_test': {'en': 'Test my strategies', 'ar': 'اختبار استراتيجياتي', 'fr': 'Tester mes stratégies', 'es': 'Probar mis estrategias', 'zh': '测试我的策略', 'ur': 'اپنی حکمت عملی کی جانچ'},
      'q16_prepare': {'en': 'Prepare for real trading', 'ar': 'الاستعداد للتداول الحقيقي', 'fr': 'Se préparer au trading réel', 'es': 'Prepararse para el trading real', 'zh': '为真实交易做准备', 'ur': 'اصل تجارت کی تیاری'},
      'q16_auto': {'en': 'Explore auto-trading', 'ar': 'استكشاف التداول الآلي', 'fr': 'Explorer le trading automatique', 'es': 'Explorar el trading automático', 'zh': '探索自动交易', 'ur': 'آٹو ٹریڈنگ کی تلاش'},

      'q17_title': {'en': 'Which industries interest you most?', 'ar': 'ما هي الصناعات التي تهمك أكثر؟', 'fr': 'Quelles industries vous intéressent le plus?', 'es': '¿Qué industrias le interesan más?', 'zh': '哪些行业最让您感兴趣？', 'ur': 'کون سی صنعتیں آپ کو سب سے زیادہ دلچسپی رکھتی ہیں؟'},
      'q17_tech': {'en': 'Technology', 'ar': 'التكنولوجيا', 'fr': 'Technologie', 'es': 'Tecnología', 'zh': '科技', 'ur': 'ٹیکنالوجی'},
      'q17_ev': {'en': 'Electric Vehicles', 'ar': 'السيارات الكهربائية', 'fr': 'Véhicules électriques', 'es': 'Vehículos eléctricos', 'zh': '电动汽车', 'ur': 'الیکٹرک گاڑیاں'},
      'q17_energy': {'en': 'Energy', 'ar': 'الطاقة', 'fr': 'Énergie', 'es': 'Energía', 'zh': '能源', 'ur': 'توانائی'},
      'q17_healthcare': {'en': 'Healthcare', 'ar': 'الرعاية الصحية', 'fr': 'Santé', 'es': 'Salud', 'zh': '医疗保健', 'ur': 'صحت کی دیکھ بھال'},
      'q17_retail': {'en': 'Retail', 'ar': 'التجزئة', 'fr': 'Commerce de détail', 'es': 'Comercio minorista', 'zh': '零售', 'ur': 'ریٹیل'},
      'q17_crypto': {'en': 'Crypto/Blockchain', 'ar': 'العملات الرقمية/البلوكتشين', 'fr': 'Crypto/Blockchain', 'es': 'Cripto/Blockchain', 'zh': '加密货币/区块链', 'ur': 'کرپٹو/بلاکچین'},
      'q17_finance': {'en': 'Finance', 'ar': 'المالية', 'fr': 'Finance', 'es': 'Finanzas', 'zh': '金融', 'ur': 'مالیات'},
      'q17_real_estate': {'en': 'Real Estate', 'ar': 'العقارات', 'fr': 'Immobilier', 'es': 'Bienes raíces', 'zh': '房地产', 'ur': 'رئیل اسٹیٹ'},

      'q18_title': {'en': 'How ready do you feel to start investing?', 'ar': 'ما مدى استعدادك للبدء في الاستثمار؟', 'fr': 'À quel point vous sentez-vous prêt à commencer à investir?', 'es': '¿Qué tan listo se siente para comenzar a invertir?', 'zh': '您觉得开始投资的准备程度如何？', 'ur': 'سرمایہ کاری شروع کرنے کے لیے آپ کتنے تیار ہیں؟'},
      'q18_need_help': {'en': 'I need guidance', 'ar': 'أحتاج إرشاد', 'fr': 'J\'ai besoin de conseils', 'es': 'Necesito orientación', 'zh': '我需要指导', 'ur': 'مجھے رہنمائی چاہیے'},
      'q18_somewhat': {'en': 'Somewhat ready', 'ar': 'مستعد نوعاً ما', 'fr': 'Assez prêt', 'es': 'Algo listo', 'zh': '有些准备', 'ur': 'کچھ تیار'},
      'q18_prepared': {'en': 'Well prepared', 'ar': 'مستعد جيداً', 'fr': 'Bien préparé', 'es': 'Bien preparado', 'zh': '准备充分', 'ur': 'اچھی طرح تیار'},
      'q18_confident': {'en': 'Very confident', 'ar': 'واثق جداً', 'fr': 'Très confiant', 'es': 'Muy confiado', 'zh': '非常有信心', 'ur': 'بہت پراعتماد'},

      'q19_title': {'en': 'How would you rate your understanding of passive income?', 'ar': 'كيف تقيّم فهمك للدخل السلبي؟', 'fr': 'Comment évalueriez-vous votre compréhension du revenu passif?', 'es': '¿Cómo calificaría su comprensión de los ingresos pasivos?', 'zh': '您如何评价您对被动收入的理解？', 'ur': 'آپ غیر فعال آمدنی کے بارے میں اپنی سمجھ کی درجہ بندی کیسے کریں گے؟'},
      'q19_dont': {'en': "I don't understand it", 'ar': 'لا أفهمه', 'fr': 'Je ne comprends pas', 'es': 'No lo entiendo', 'zh': '我不理解', 'ur': 'میں نہیں سمجھتا'},
      'q19_basic': {'en': 'Basic understanding', 'ar': 'فهم أساسي', 'fr': 'Compréhension basique', 'es': 'Comprensión básica', 'zh': '基本理解', 'ur': 'بنیادی سمجھ'},
      'q19_good': {'en': 'Good understanding', 'ar': 'فهم جيد', 'fr': 'Bonne compréhension', 'es': 'Buena comprensión', 'zh': '良好理解', 'ur': 'اچھی سمجھ'},
      'q19_excellent': {'en': 'Excellent understanding', 'ar': 'فهم ممتاز', 'fr': 'Excellente compréhension', 'es': 'Excelente comprensión', 'zh': '极好的理解', 'ur': 'بہترین سمجھ'},

      'q20_title': {'en': 'What demo portfolio size would you prefer to start with?', 'ar': 'ما حجم المحفظة التجريبية التي تفضل البدء بها؟', 'fr': 'Quelle taille de portefeuille de démonstration préféreriez-vous pour commencer?', 'es': '¿Con qué tamaño de cartera de demostración preferiría comenzar?', 'zh': '您希望从多大的模拟投资组合开始？', 'ur': 'آپ کس ڈیمو پورٹ فولیو سائز سے شروع کرنا پسند کریں گے؟'},
      'q20_1k': {'en': '\$1,000', 'ar': '1,000\$', 'fr': '1 000\$', 'es': '\$1,000', 'zh': '\$1,000', 'ur': '\$1,000'},
      'q20_10k': {'en': '\$10,000', 'ar': '10,000\$', 'fr': '10 000\$', 'es': '\$10,000', 'zh': '\$10,000', 'ur': '\$10,000'},
      'q20_25k': {'en': '\$25,000', 'ar': '25,000\$', 'fr': '25 000\$', 'es': '\$25,000', 'zh': '\$25,000', 'ur': '\$25,000'},
      'q20_50k': {'en': '\$50,000', 'ar': '50,000\$', 'fr': '50 000\$', 'es': '\$50,000', 'zh': '\$50,000', 'ur': '\$50,000'},
      'q20_100k': {'en': '\$100,000', 'ar': '100,000\$', 'fr': '100 000\$', 'es': '\$100,000', 'zh': '\$100,000', 'ur': '\$100,000'},

      // Common
      'continue': {'en': 'Continue', 'ar': 'متابعة', 'fr': 'Continuer', 'es': 'Continuar', 'zh': '继续', 'ur': 'جاری رکھیں'},
      'back': {'en': 'Back', 'ar': 'رجوع', 'fr': 'Retour', 'es': 'Atrás', 'zh': '返回', 'ur': 'واپس'},
      'question': {'en': 'Question', 'ar': 'سؤال', 'fr': 'Question', 'es': 'Pregunta', 'zh': '问题', 'ur': 'سوال'},
      'of': {'en': 'of', 'ar': 'من', 'fr': 'sur', 'es': 'de', 'zh': '的', 'ur': 'کا'},
      'select_all': {'en': 'Select all that apply', 'ar': 'اختر كل ما ينطبق', 'fr': 'Sélectionnez tout ce qui s\'applique', 'es': 'Seleccione todo lo que corresponda', 'zh': '选择所有适用的', 'ur': 'سب کا انتخاب کریں جو لاگو ہو'},

      // Component badges and buttons
      'choose_one': {'en': 'Choose one', 'ar': 'اختر واحداً', 'fr': 'Choisissez-en un', 'es': 'Elija uno', 'zh': '选择一个', 'ur': 'ایک چنیں'},
      'tap_select': {'en': 'Tap to select', 'ar': 'انقر للاختيار', 'fr': 'Appuyez pour sélectionner', 'es': 'Toque para seleccionar', 'zh': '点击选择', 'ur': 'منتخب کرنے کے لیے ٹیپ کریں'},
      'select_multiple': {'en': 'Select multiple', 'ar': 'اختر عدة خيارات', 'fr': 'Sélectionnez plusieurs', 'es': 'Seleccione múltiples', 'zh': '选择多个', 'ur': 'متعدد منتخب کریں'},
      'selected': {'en': 'selected', 'ar': 'مختار', 'fr': 'sélectionné', 'es': 'seleccionado', 'zh': '已选择', 'ur': 'منتخب'},
      'helper_rating': {'en': '1 = No knowledge, 5 = Excellent', 'ar': '1 = لا معرفة، 5 = ممتاز', 'fr': '1 = Aucune connaissance, 5 = Excellent', 'es': '1 = Sin conocimiento, 5 = Excelente', 'zh': '1 = 无知识，5 = 优秀', 'ur': '1 = کوئی علم نہیں، 5 = بہترین'},
      'rate_all': {'en': 'Rate all areas to continue', 'ar': 'قيّم جميع المجالات للمتابعة', 'fr': 'Évaluez tous les domaines pour continuer', 'es': 'Califique todas las áreas para continuar', 'zh': '评估所有领域以继续', 'ur': 'جاری رکھنے کے لیے تمام شعبوں کی درجہ بندی کریں'},
      'got_it': {'en': 'Got it', 'ar': 'فهمت', 'fr': 'Compris', 'es': 'Entendido', 'zh': '明白了', 'ur': 'سمجھ گیا'},

      // Knowledge areas for Q6
      'area_stock_market': {'en': 'Stock Market', 'ar': 'سوق الأسهم', 'fr': 'Marché boursier', 'es': 'Mercado de valores', 'zh': '股票市场', 'ur': 'سٹاک مارکیٹ'},
      'area_risk_management': {'en': 'Risk management', 'ar': 'إدارة المخاطر', 'fr': 'Gestion des risques', 'es': 'Gestión de riesgos', 'zh': '风险管理', 'ur': 'رسک مینجمنٹ'},
      'area_technical_analysis': {'en': 'Technical and fundamental analysis', 'ar': 'التحليل الفني والأساسي', 'fr': 'Analyse technique et fondamentale', 'es': 'Análisis técnico y fundamental', 'zh': '技术和基本面分析', 'ur': 'تکنیکی اور بنیادی تجزیہ'},
      'area_portfolio_diversification': {'en': 'Portfolio diversification', 'ar': 'تنويع المحفظة', 'fr': 'Diversification du portefeuille', 'es': 'Diversificación de cartera', 'zh': '投资组合多元化', 'ur': 'پورٹ فولیو ڈائیورسیفیکیشن'},
    };
                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (context) => [
                        ...
                        _buildLanguageMenuItem('ur', '🇵🇰 اردو'),
                      ],
                    ),
                  ],
                ),
